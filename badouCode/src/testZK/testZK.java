...
public class testZK implements Watcher {
	...
	boolean bk = true;
	private CountDownLatch zkConnectedSignal = new CountDownLatch(1);
...
//					CreateMode.EPHEMERAL);
			String pth = this.zk.create(path, data.getBytes(), Ids.OPEN_ACL_UNSAFE,
					CreateMode.PERSISTENT);
			System.out.println("node:" + pth + " created");
	...
	public static void main(String[] args) {
		...
		test.CreateConnection("192.168.183.10:2181", 100000);
...
//		}
	...
	public void process(WatchedEvent event) {
		// TODO Auto-generated method stub
		System.out.println("get event" + event.getState() + " # "+ event.getType() + "\n");
